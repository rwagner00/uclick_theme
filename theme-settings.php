...
/**
 * USAGE:
 * 1 - To use this file replace "uclick_theme" with the name of
...
// Replace 'uclick_theme' with your themes name, eg:
// function your_themes_name_form_system_theme_settings_alter(&$form, &$form_state)
function uclick_theme_form_system_theme_settings_alter(&$form, &$form_state)  {
